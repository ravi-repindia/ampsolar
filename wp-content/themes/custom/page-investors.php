...
<section id="sp-page-title">
         ...
         <section id="sp-main-body" class="investor-body">
            <div class="row">
                                                   ...
                                                   <div class="sppb-addon sppb-addon-sppb-flibox  rotate_style flip_right flipon-hover sppb-text-center">
                                                      <div class="sppb-flipbox-panel">
                                                         <div class="sppb-flipbox-front flip-box">
                                                            <div class="flip-box-inner middle-investor">
                                                               <div class="img-tm"><img class="sppb-img-responsive" src="<?php the_post_thumbnail_url(); ?>" alt="Image" title=""></div>
                                                            </div>
                                                         </div>
