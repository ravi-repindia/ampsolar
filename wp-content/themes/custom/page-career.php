                           ...
                           <div class="page-content">
                                                ...
                                                <div id="sppb-addon-wrapper-1573823142695" class="sppb-addon-wrapper">
                                                   <div id="sppb-addon-1573823142695" class="clearfix "     >
                                                      <div class="sppb-addon sppb-addon-text-block sppb-text-center ">
                                                         <div class="sppb-addon-content">We’re a growing global team, always on the search for great talent. Use the form below to apply to any one of our current openings. Don’t see your perfect role listed? Submit a general application and we’ll reach out when an opportunity arises.</div>
                                                      </div>
                                                   </div>
                                                </div>
                                             </div>
                              ...
                              <section id="section-id-1573823142689" class="sppb-section contact-form-section" >
                                 ...
                                 <div class="sppb-row-container">
                                    <div class="sppb-row">
                                       <div class="sppb-col-md-6" id="column-wrap-id-1573823142687">
                                          <div id="column-id-1573823142687" class="sppb-column" >
                                                ...
                                                <div id="sppb-addon-wrapper-1573823142692" class="sppb-addon-wrapper">
                                                   <div id="sppb-addon-1573823142692" class="clearfix "     >
                                                      <div class="sppb-addon sppb-addon-header sppb-text-left">
                                                         <h2 class="sppb-addon-title">Don’t see your perfect role listed? Send us a quick note and we’ll reach out when an opportunity arises.</h2>
                                                      </div>
                                                   </div>
                                                </div>
                                           ...
                                           <div id="sppb-addon-wrapper-1574685060161" class="sppb-addon-wrapper"><div id="sppb-addon-1574685060161" class="clearfix "><div class="sppb-addon sppb-addon-text-block  "><div class="sppb-addon-content">+1 (905) 271-0790 <br>info@amp.energy</div></div></div></div>
                                    ...
                                    <?php echo do_shortcode('[contact-form-7 id="142" title="Career"]'); ?>
